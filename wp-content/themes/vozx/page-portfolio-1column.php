...
<section>
	<div class="container">
	<div class="row">
		<div id="portfolio_single_column" class="<?php echo (isset($values['ABdev_portfolio_gallery_style'][0]) && $values['ABdev_portfolio_gallery_style'][0] == 1) ? 'portfolio_single_column_gallery' : '' ;?> <?php echo (isset($values['ABdev_portfolio_gallery_style2'][0]) && $values['ABdev_portfolio_gallery_style2'][0] == 1) ? 'portfolio_single_column_gallery_style2' : '' ;?> <?php (isset($values['ABdev_portfolio_page_layout'][0])) ? _e($values['ABdev_portfolio_page_layout'][0]) : '' ;?> <?php echo (isset($values['ABdev_portfolio_page_layout'][0]) && $values['ABdev_portfolio_page_layout'][0]=='portfolio_full_width' )?'span12 content':'span9 content';?> <?php echo (isset($values['ABdev_portfolio_page_layout'][0]) && $values['ABdev_portfolio_page_layout'][0]=='portfolio_left_sidebar')?'content_with_left_sidebar': ( (isset($values['ABdev_portfolio_page_layout'][0]) && $values['ABdev_portfolio_page_layout'][0]=='portfolio_right_sidebar') ?'content_with_right_sidebar' : '');?>">
			<?php
			...
			<?php 
				...
				$portfolio_description_class = (isset($values['ABdev_show_portfolio_description']) && $values['ABdev_show_portfolio_description'][0] == 1) ? $values['ABdev_show_portfolio_description'][0] : 'portfolio_description';
			?>

					<?php if( (isset($values['ABdev_portfolio_gallery_style'][0]) && $values['ABdev_portfolio_gallery_style'][0] == 1) || (isset($values['ABdev_portfolio_gallery_style2'][0]) && $values['ABdev_portfolio_gallery_style2'][0] == 1)):?>
					<div class="portfolio_single_column_item">
						<div class="row portfolio_inner_content">
							<div class="portfolio_item">
								<div class="overlayed">
									<?php echo get_the_post_thumbnail();?>
									<a class="overlay fancybox" data-fancybox-group="portfolio" href="<?php echo esc_url( wp_get_attachment_url( get_post_thumbnail_id($post->ID) ) );?>">
					...
					<div class="portfolio_single_column_item <?php echo (isset($values['ABdev_show_portfolio_description'][0]) && $values['ABdev_show_portfolio_description'][0]== 1) ?'portfolio_description' : '';?>">
						<div class="row portfolio_inner_content">
							<div class="portfolio_item">
								<div class="overlayed">
									<?php echo get_the_post_thumbnail();?>
							...
							<div class="span12 single_portfolio">

								<?php if(isset($values['ABdev_show_portfolio_description'][0]) && $values['ABdev_show_portfolio_description'][0] == 1):?>
									<div class="portfolio_item_meta left_aligned">
										<h5 class="left_aligned"><a href="<?php the_permalink();?>"><?php the_title(); ?></a></h5>
								...
								<?php else: ?>
									<div class="portfolio_item_meta">
										<h6 class="column_title_left"><a href="<?php the_permalink();?>"><?php the_title(); ?></a></h6>
										<p class="portfolio_single_detail">
											<span class="portfolio_item_meta_data">
												<?php echo esc_attr($categories); ?>
											</span>
