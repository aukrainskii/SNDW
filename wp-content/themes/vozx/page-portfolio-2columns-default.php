...
$read_more=esc_attr__('Read More','ABdev_vozx');
...
<section>
	<div class="container <?php echo (isset($values['ABdev_show_portfolio_description'][0]) && $values['ABdev_show_portfolio_description'][0]== 1) ?'portfolio_2columns_description' : '';?>">
		<div class="row portfolio_2column <?php echo (isset($values['ABdev_portfolio_gallery_style'][0]) && $values['ABdev_portfolio_gallery_style'][0]== 1)?'portfolio_2column_gallery': ( (isset($values['ABdev_portfolio_gallery_style2'][0]) && $values['ABdev_portfolio_gallery_style2'][0]== 1) ?'portfolio_2column_gallery_style2' : '');?>">
			<div class="<?php (isset($values['ABdev_portfolio_page_layout'][0])) ? _e($values['ABdev_portfolio_page_layout'][0]) : '' ;?> <?php echo (isset($values['ABdev_portfolio_page_layout'][0]) && $values['ABdev_portfolio_page_layout'][0]=='portfolio_full_width' )?'span12 content':'span9 content';?> <?php echo (isset($values['ABdev_portfolio_page_layout'][0]) && $values['ABdev_portfolio_page_layout'][0]=='portfolio_left_sidebar')?'content_with_left_sidebar': ( (isset($values['ABdev_portfolio_page_layout'][0]) && $values['ABdev_portfolio_page_layout'][0]=='portfolio_right_sidebar') ?'content_with_right_sidebar' : '');?>">
				<div class="row">
				<?php
				$values = get_post_custom( $post->ID );
							...
							<div class="portfolio_inner_content">
								...
								<?php if(isset($values['ABdev_show_portfolio_description'][0]) && $values['ABdev_show_portfolio_description'][0] == 1):?>
									<div class="portfolio_item_meta_detail_description">
										...
										<p class="portfolio_2column_detail">
								...
								<?php else: ?>
									<div class="portfolio_item_meta">
										...
										<p class="portfolio_2column_info">
											<span class="portfolio_item_meta_data">
												<?php echo esc_attr($categories); ?>
											</span>
										</p>
