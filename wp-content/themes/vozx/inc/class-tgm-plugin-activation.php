        ...
        class TGM_Plugin_Activation {
                ...
                protected function do_plugin_install() {
                        ...
                        if ( isset( $_GET[sanitize_key( 'plugin' )] ) && ( ( isset( $_GET[sanitize_key( 'tgmpa-install' )] ) && 'install-plugin' == $_GET[sanitize_key( 'tgmpa-install' )] ) || ( isset( $_GET[sanitize_key( 'tgmpa-update' )] ) && 'update-plugin' == $_GET[sanitize_key( 'tgmpa-update' )] ) ) ) {
                                ...
                                $plugin['source'] = urldecode($_GET['plugin_source']); // Plugin source.
                ...
                public function notices() {
                        ...
                        if ( ! empty( $message ) ) {
                                ...
                                $show_update_link  = $update_link ? '<a href="' . add_query_arg( 'page', $this->menu, admin_url( 'themes.php' ) ) . '">' . translate_nooped_plural( $this->strings['update_link'], $update_link_count, 'artless' ) . '</a>' : '';
                ...
                protected function _gather_plugin_data() {
                        ...
                        foreach ( TGM_Plugin_Activation::$instance->plugins as $plugin ) {
                                ...
                                if ( ! isset( $installed_plugins[$plugin['file_path']] ) ) {
                                        ...
                                        $table_data[$i]['status'] = sprintf( '%1$s', __( 'Not Updated', 'artless' ) );
                                } else {
                                        $table_data[$i]['status'] = sprintf( '%1$s', __( 'Active', 'artless' ) );
                                }
