...
<header id="ABdev_main_header" class="clearfix header_layout_3 <?php echo esc_attr($sticky_header_class).' '. esc_attr($switch_header_class); ?>">
	<?php if(isset($vozx_options['show_top_bar']) && $vozx_options['show_top_bar']==1): ?>
	<div id="top_bar">
		<div class="container">
			<div class="row">
				<div id="header_social_info" class="span12">
					<?php 
	...
	<div id="nav_menu_bar">
		<div class="container">
			<div id="logo">
				<a href="<?php echo esc_url(home_url()); ?>" class="logo"><img src="<?php echo (isset($vozx_options['header_logo']['url']) && $vozx_options['header_logo']['url'] != '') ? esc_url( $vozx_options['header_logo']['url'] ) : TEMPPATH.'/images/logo.png';?>" alt="<?php esc_attr(bloginfo('name'));?>"></a>
			</div>
			<nav>
