...
<header id="ABdev_main_header" class="clearfix header_layout_2 <?php echo esc_attr($sticky_header_class); ?>">
	<?php if(isset($vozx_options['show_top_bar']) && $vozx_options['show_top_bar']==1): ?>
	<div id="top_bar">
		<div class="container">
			<div class="row">
				<div id="header_social_info" class="span9">
					<?php 
				...
				<div id ="login_button_area" class="span3 right_aligned">
					...
					<?php global $woocommerce; ?>
						<span id="shop_links" class="cart_right"><?php _e('Cart: ','ABdev_vozx') ?>
							<a class="link_cart" href="<?php echo esc_url($woocommerce->cart->get_cart_url()); ?>">
								<span>
								<?php 
									echo '<span class="items_count">' . $woocommerce->cart->cart_contents_count . '</span> ' ._n('item', 'items',  $woocommerce->cart->cart_contents_count ,'ABdev_vozx')  ;
								?>
								</span>
								<i class="ci_icon-shopping-cart"></i>
							</a>
						</span>
					<?php endif; ?>
					<?php 
