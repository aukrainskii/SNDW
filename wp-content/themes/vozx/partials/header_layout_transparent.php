<?php 
	...
	$switch_header_class = ((isset($vozx_options['header_with_switch']) && $vozx_options['header_with_switch'] == 1)) ? 'switch_main_header' : '';
...
<header id="ABdev_main_header" class="clearfix transparent <?php echo esc_attr($sticky_header_class) .' '. echo($switch_header_class); ?>">
	...
	<div id="top_bar" class=" transparent">
		<div class="container">
			<div class="row">
				<div id="header_social_info" class="span8">
					...
					<?php if(isset($vozx_options['header_last_fm_url']) && $vozx_options['header_last_fm_url'] != ''):?>
						<a href="<?php echo esc_url($vozx_options['header_last_fm_url']);?>" class="top_social_icon top_social_icon_lastfm dnd_tooltip" title="<?php esc_attr_e('Follow us on Last.fm','ABdev_vozx'); ?>" data-gravity="n" target="<?php echo esc_attr($target); ?>"><i class="ci_icon-lastfm"></i></a>
					<?php endif;?>
				...
				<div id="login_button_area" class="span4 right_aligned">
					<?php 
		...
		<div class="container">
			<div id="logo">
				<a href="<?php echo esc_url(home_url()); ?>">
					<img id="main_logo" src="<?php echo (isset($vozx_options['header_logo']['url']) && $vozx_options['header_logo']['url'] != '') ? esc_url($vozx_options['header_logo']['url']) : TEMPPATH.'/images/logo.png';?>" alt="<?php bloginfo('name');?>">
					<?php if(isset($vozx_options['header_with_switch']) && $vozx_options['header_with_switch']==1):?>
						<img id="inverted_logo" src="<?php echo (isset($vozx_options['inverted_header_logo']['url']) && $vozx_options['inverted_header_logo']['url'] != '') ? esc_url($vozx_options['inverted_header_logo']['url']) : TEMPPATH.'/images/logo_inversed.png';?>" alt="<?php esc_attr(bloginfo('name'));?>">
					<?php endif; ?>
				</a>
			</div>
			<nav>
				<div class="search-toggle">
					...
					<?php if(isset($vozx_options['hide_top_bar']) && $vozx_options['hide_top_bar']==1):?>
						<div id="search-container" class="search-box-wrapper hide top_bar_hidden">
