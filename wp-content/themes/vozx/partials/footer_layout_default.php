				...
				<div class="container">
					<div class="row">
						<div class="span3 clearfix">
							<?php dynamic_sidebar( __('First Footer Widget', 'ABdev_vozx') );?>
						</div>
						<div class="span3 clearfix">
							<?php dynamic_sidebar( __('Second Footer Widget', 'ABdev_vozx') );?>
						</div>
						<div class="span3 clearfix">
							<?php dynamic_sidebar( __('Third Footer Widget', 'ABdev_vozx') );?>
						</div>
						<div class="span3 clearfix">
							<?php dynamic_sidebar( __('Fourth Footer Widget', 'ABdev_vozx') );?>
						</div>
					</div>
				</div>
			</div>
