...
<header id="ABdev_main_header" class="clearfix header_layout_4 <?php echo $sticky_header_class; ?>">
		...
		<div class="container">
			...
			<?php if(isset($vozx_options['woocommerce_catalog']) && $vozx_options['woocommerce_catalog'] != 1) :?>
				...
				<?php global $woocommerce; ?>
					<div id="shop_links" class="cart_right"><?php esc_attr_e('Cart:','ABdev_vozx') ?>
