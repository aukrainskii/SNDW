...
function abts_consumer_screen_name_render() { 
	...
	?>
	<input type='text' class="regular-text ltr" name='abts_settings[abts_consumer_screen_name]' value='<?php echo esc_attr($abts_consumer_screen_name); ?>'>
	<?php
}
...
function abts_consumer_key_render() { 
	...
	?>
	<input type='text' class="regular-text ltr" name='abts_settings[abts_consumer_key]' value='<?php echo esc_attr($abts_consumer_key); ?>'>
	<?php
}
...
function abts_consumer_secret_render() { 
	...
	?>
	<input type='text' class="regular-text ltr" name='abts_settings[abts_consumer_secret]' value='<?php echo esc_attr($abts_consumer_secret); ?>'>
	<?php
}
...
function abts_access_token_render() { 
	...
	?>
	<input type='text' class="regular-text ltr" name='abts_settings[abts_access_token]' value='<?php echo esc_attr($abts_access_token); ?>'>
	<?php
}
...
function abts_access_token_secret_render() { 
	...
	?>
	<input type='text' class="regular-text ltr" name='abts_settings[abts_access_token_secret]' value='<?php echo esc_attr($abts_access_token_secret); ?>'>
	<?php
}
...
function abts_expiration_render() { 
	...
	?>
	<input type='text' class="regular-text ltr" name='abts_settings[abts_expiration]' value='<?php echo esc_attr($abts_expiration); ?>'>
