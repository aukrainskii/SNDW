...
function ABdevDND_alert_box_dd_shortcode( $attributes, $content = null ) {
	...
	$icon_out = ($no_icon != '1') ? '<i class="ABdev_icon-' . esc_attr($icons[$style]) . '"></i> ' : '';
	$close_button = ( $no_close != 1 ) ? '<a class="dnd_alert_box_close" title="' . esc_attr__('Close', 'dnd-shortcodes' ) . '">&#10005;</a>' : '';
	return '<div class="'. esc_attr($style_out) . '">
