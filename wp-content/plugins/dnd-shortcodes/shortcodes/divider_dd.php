...
function ABdevDND_divider_dd_shortcode( $attributes ) {
	...
	return '<div class="dnd_divider '.esc_attr($divider_style).'"><a href="#" class="backtotop'.esc_attr($animation_class).'"'.$animation_animation.$animation_duration.'>'.$text.$icon_output.'</a></div>';
}
