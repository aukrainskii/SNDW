...
function ABdevDND_tabs_dd_shortcode( $attributes, $content = null ) {
	...
	$return = '
		<div class="dnd-tabs dnd-tabs-'.esc_attr($slide_direction).' dnd-tabs-position-'.esc_attr($tabs_position).' '.esc_attr($class).'" data-selected="'.esc_attr($selected).'" data-break_point="'.esc_attr($break_point).'" data-effect="'.esc_attr($effect).'">
			<ul>
				'.$tabs_navigation.'
			</ul>
