...
function dnd_settings_init(  ) { 
	...
	add_settings_field( 
		'dnd_custom_map_style', 
		__( 'Custom Map Styling', 'dnd-shortcodes' ), 
		'dnd_custom_map_style_render', 
		'dnd_options_page', 
		'dnd_shortcodes_settings' 
	);
...
function dnd_sidebars_render(  ) { 
	...
	?>
	<input type='text' name='dnd_settings[dnd_sidebars]' value='<?php echo esc_attr($dnd_sidebars); ?>'>
